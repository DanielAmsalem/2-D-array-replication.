...
def main(import_export: IMPORT_EXPORT, run_name) -> None:
    ...
    last_repetition_to_do = 9  # int : n -> the last repetition has dT = n*Tstd
    fraction_repetition_list = [2,4,6,8] #
    ...
    while current_at_V0:
        ...
        T_std = (7 + repetition / 10) * init.T0 / 20
...
if __name__ == "__main__":
    ...
    main(
        IMPORT_EXPORT(
            ...
            prepare_table_triplets_file_list=[EXPORT_PATH / f"table_triplets_Tstd7.{n}_20.npz" for n in range(10)],
